...
async function sendWelcomeEmail(email: string, orgName: string): Promise<void> {
  ...
  const html = '<!DOCTYPE html>' +
    ...
    '<span style="color:#ffffff;font-size:16px;font-weight:700;">RG &nbsp; RIPS Guard</span>' +
    '</td></tr>' +
    ...
    '<tr><td>' +
    '<p style="margin:0 0 12px;font-size:13px;font-weight:700;color:#64748b;text-transform:uppercase;">Qu&eacute; puedes hacer ahora</p>' +
    '<table cellpadding="0" cellspacing="0">' +
    '<tr><td style="padding:6px 0;"><span style="color:#22c55e;margin-right:10px;">&#10003;</span><span style="font-size:14px;color:#334155;">Subir archivos RIPS JSON o ZIP</span></td></tr>' +
    '<tr><td style="padding:6px 0;"><span style="color:#22c55e;margin-right:10px;">&#10003;</span><span style="font-size:14px;color:#334155;">Detectar errores en m&oacute;dulos AF, AT, AC, AM, AN y AU</span></td></tr>' +
    '<tr><td style="padding:6px 0;"><span style="color:#22c55e;margin-right:10px;">&#10003;</span><span style="font-size:14px;color:#334155;">Exportar reportes de errores para tu equipo</span></td></tr>' +
    '</table></td></tr></table>' +
    '<table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">' +
    '<a href="' + auditUrl + '" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;padding:14px 36px;border-radius:8px;">Subir mi primer RIPS &rarr;</a>' +
    '</td></tr></table>' +
    '</td></tr>' +
    '<tr><td style="padding:20px 40px;border-top:1px solid #f1f5f9;">' +
    '<p style="margin:0;font-size:12px;color:#94a3b8;text-align:center;">RIPS Guard &mdash; Hecho en Colombia &bull; <a href="' + APP_URL + '" style="color:#2563eb;text-decoration:none;">ripsguard.com</a></p>' +
    '</td></tr>' +
