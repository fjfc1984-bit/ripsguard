...
function BillingContent({ subscription }: { subscription: SubscriptionStatus }) {
  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="mb-7">
        <h1 className="text-xl font-bold text-slate-900 tracking-tight">Plan y facturación</h1>
        <p className="text-sm text-slate-500 mt-0.5">Elige el plan que mejor se adapte a tu organización</p>
      </div>
      ...
      {successParam && (
        <div className="mb-5 flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg px-5 py-3.5 text-green-800 text-sm">
          ...
          <span><strong>Pago exitoso.</strong> Tu suscripción se activará en unos segundos.</span>
        </div>
      )}
      {canceledParam && (
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {plan.highlight && (
                      <span className="text-[10px] font-bold uppercase tracking-wide px-2 py-0.5 rounded-full bg-blue-600 text-white">
                        Recomendado
                      </span>
                    )}
                    {isCurrent && (
