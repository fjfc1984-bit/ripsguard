...
const PLANS = {
  ...
  enterprise: { amount: 699000, name: 'RIPS Guard Enterprise - 1 mes' },
} as const
...
export async function POST(request: Request) {
  ...
  // 6. URL de redireccion tras el pago
