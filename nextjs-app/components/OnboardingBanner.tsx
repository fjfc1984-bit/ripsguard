 ...
 * Los cards de pasos navegan sin descartar el banner — el usuario
 * puede explorarlo antes de cerrarlo manualmente.
 */
...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'PDF o JSON para tu equipo de facturación',
    href: '/dashboard/history',
    cta: 'Ver historial',
  },
]
...
/**
 * OnboardingBanner — aparece en el primer acceso al dashboard.
 * Se oculta permanentemente cuando el usuario completa el paso o cierra el banner.
 * Usa sessionStorage para no volver a aparecer en la misma sesión después de cerrar.
 */

import { useState, useEffect } from 'react'
import Link from 'next/link'
import { XIcon, ZapIcon, SearchIcon, HistoryIcon } from '@/components/ui/icons'
